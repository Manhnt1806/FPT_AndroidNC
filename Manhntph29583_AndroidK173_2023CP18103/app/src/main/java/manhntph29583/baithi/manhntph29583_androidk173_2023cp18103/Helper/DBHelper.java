package manhntph29583.baithi.manhntph29583_androidk173_2023cp18103.Helper;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createTableSanPham = "CREATE TABLE sanPham(maSanPham TEXT NOT NULL,tenSanPham TEXT NOT NULL, nam TEXT, maTheLoai TEXT REFERENCES theLoai(maTheLoai))";
