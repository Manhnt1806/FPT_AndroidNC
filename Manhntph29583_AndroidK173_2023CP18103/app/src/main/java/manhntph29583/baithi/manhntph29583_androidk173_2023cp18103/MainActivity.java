...
public class MainActivity extends AppCompatActivity {
    ...
    EditText edMaLoai,edMaSP,edTenSP,edSoLuongNhap,edNam, edSoLuongXuat,edDonGiaNhap,edDonGiaXuat,edNgayNhap,edNgayXuat;
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validate()>0){
                    ...
                    sanPham.setNam(edNam.getText().toString());
